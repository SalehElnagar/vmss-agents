...
$url = "https://dev.azure.com/salehelnaggar"
$pat = "l5iiibdxa3q6mu2f7nvwcit5i2lqjty3iyssnpsmc6kjvnojsj6q"
$installPackage = "https://vstsagentpackage.azureedge.net/agent/2.185.0/vsts-agent-win-x64-2.185.0.zip"
...
.\config.cmd --unattended --url $url --auth PAT --token $pat --pool "Default" --agent "self-agent-VMSS2" --replace --runAsService
